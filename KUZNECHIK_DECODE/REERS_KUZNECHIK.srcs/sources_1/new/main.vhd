	...
	--keygen signals
			...
			--text encode signals
				signal secworkBlock, secinputBlockPo, outputBlockNotPo,doubleSized, secdoubleSized, thirdoubleSized:  unsigned(0 to 15);
	    ...
	    procedure tableShiftKey(signal inputPart: in unsigned(0 to 7); signal result:out unsigned(0 to 7)) is
	    begin
	    	C: case inputPart is
				    when "11111100" => 
				       result(0) <= '0';
		...
		procedure textBlockEncoding(signal inputBlockPo, keyPo: in unsigned(0 to 15); 
			signal workBlock, doubleSized: inout unsigned(0 to 15);
		...
		begin
			--x
				xor16bit(firBlock=>workBlock, secBlock=>keyPo, result=>outputBlockPo);
				workBlock(0)  <= outUnsigned(0);
		        workBlock(1)  <= outUnsigned(1);
		        workBlock(2)  <= outUnsigned(2);
		        workBlock(3)  <= outUnsigned(3);
		        workBlock(4)  <= outUnsigned(4);
		        workBlock(5)  <= outUnsigned(5);
		        workBlock(6)  <= outUnsigned(6);
		        workBlock(7)  <= outUnsigned(7);
		        workBlock(8)  <= outUnsignedD(0);
		        workBlock(9)  <= outUnsignedD(1);
		        workBlock(10) <= outUnsignedD(2);
		        workBlock(11) <= outUnsignedD(3);
		        workBlock(12) <= outUnsignedD(4);
		        workBlock(13) <= outUnsignedD(5);
		        workBlock(14) <= outUnsignedD(6);
		        workBlock(15) <= outUnsignedD(7);

	        --s
		        temp(0) <= doubleSized(0);
		        temp(1) <= doubleSized(1);
		        temp(2) <= doubleSized(2);
		        temp(3) <= doubleSized(3);
		        temp(4) <= doubleSized(4);
		        temp(5) <= doubleSized(5);
		        temp(6) <= doubleSized(6);
		        temp(7) <= doubleSized(7);
				tableShift(inputPart=>temp, result=>outUnsigned);

		        temp2(0) <= doubleSized(8);
		        temp2(1) <= doubleSized(9);
		        temp2(2) <= doubleSized(10);
		        temp2(3) <= doubleSized(11);
		        temp2(4) <= doubleSized(12);
		        temp2(5) <= doubleSized(13);
		        temp2(6) <= doubleSized(14);
		        temp2(7) <= doubleSized(15);
		        tableShift(inputPart=>temp2, result=>outUnsignedD);

		    --l
		    	numToPower(numba=>InputBlockPo(0 to 7), result=>testKey1);
		 		numToPower(numba=>InputBlockPo(8 to 15), result=>testKey2);
		 		...
		 		doubleSized(0)  <= SecBlocCon(0);
				doubleSized(1)  <= SecBlocCon(1);
				doubleSized(2)  <= SecBlocCon(2);
				doubleSized(3)  <= SecBlocCon(3);
				doubleSized(4)  <= SecBlocCon(4);
				doubleSized(5)  <= SecBlocCon(5);
				doubleSized(6)  <= SecBlocCon(6);
				doubleSized(7)  <= SecBlocCon(7);
				doubleSized(8)  <= firBlocCon(0) xor SecBlocCon(0);
				doubleSized(9)  <= firBlocCon(1) xor SecBlocCon(1);
				doubleSized(10) <= firBlocCon(2) xor SecBlocCon(2);
				doubleSized(11) <= firBlocCon(3) xor SecBlocCon(3);
				doubleSized(12) <= firBlocCon(4) xor SecBlocCon(4);
				doubleSized(13) <= firBlocCon(5) xor SecBlocCon(5);
				doubleSized(14) <= firBlocCon(6) xor SecBlocCon(6);
				doubleSized(15) <= firBlocCon(7) xor SecBlocCon(7);
	    ...
	    begin
			...
			tableShiftKey(inputPart=>firIterXor(0 to 7), result=>firIterS1);
			tableShiftKey(inputPart=>firIterXor(8 to 15), result=>firIterS2);
...
--		eight iterations of keygen function to calculate k3 k4
		...
		--four iterations of encoding text
			textBlockEncoding(doubleSized=>doubleSized, inputBlockPo=>thirinputBlockPo, keyPo=>masterKey1, workblock=>workblock, temp=>temp, temp2=>temp2, outUnsigned=>outUnsigned,
			...
			textBlockEncoding(doubleSized=>secdoubleSized, inputBlockPo=>fouinputBlockPo, keyPo=>masterKey2, workblock=>secworkblock, temp=>sectemp, temp2=>sectemp2, outUnsigned=>secoutUnsigned,
			...
			textBlockEncoding(doubleSized=>thirdoubleSized,inputBlockPo=>fououtputBlockPo, keyPo=>eigIterIn, workblock=>thirworkblock, temp=>thirtemp, temp2=>thirtemp2, outUnsigned=>thiroutUnsigned,
			...
			xor16bit(firBlock=>inputBlockPo, secBlock=>ninIterIn, result=>fououtputBlockPo);

		--ÂÛÂÎÄ
			outputBlockPort(0)  <= secinputBlockPo(0);
			outputBlockPort(1)  <= secinputBlockPo(1);
			outputBlockPort(2)  <= secinputBlockPo(2);
			outputBlockPort(3)  <= secinputBlockPo(3);
			outputBlockPort(4)  <= secinputBlockPo(4);
			outputBlockPort(5)  <= secinputBlockPo(5);
			outputBlockPort(6)  <= secinputBlockPo(6);
			outputBlockPort(7)  <= secinputBlockPo(7);
			outputBlockPort(8)  <= secinputBlockPo(8);
			outputBlockPort(9)  <= secinputBlockPo(9);
			outputBlockPort(10) <= secinputBlockPo(10);
			outputBlockPort(11) <= secinputBlockPo(11);
			outputBlockPort(12) <= secinputBlockPo(12);
			outputBlockPort(13) <= secinputBlockPo(13);
			outputBlockPort(14) <= secinputBlockPo(14);
			outputBlockPort(15) <= secinputBlockPo(15);
